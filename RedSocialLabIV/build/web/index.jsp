                ...
                <div class="col col-md-12">
                    <div id="contentLogin" class="form jumbotron col-md-6 col-md-push-3" >
                        ...
                        <form name="loginForm" role="form" action="loginCtrl">
                            ...
                            <div class="form-group">
                                <input type="submit" id="submit" class="btn btn-primary form-control" value="Entrar como administrador"/>
                            </div>   

                        </form>


                        <div class="card card-signin my-5" style="background-color: #b9c7da">
                            <div class="card-body">
                                <form >
                                    <a href="homeUsuario.jsp" type="button" id="submit" class="btn btn-primary form-control" >Entrar como invitado</a>
                                </form>
                            </div>
                        </div>
                    </div>
